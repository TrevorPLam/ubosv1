...
import { LayoutDashboard, MessageSquare, KanbanSquare, CalendarDays, FolderOpen, Banknote, LineChart, FileText, Database, Blocks, Settings, Activity, PanelLeftClose, PanelLeftOpen, Users, Building2 } from "lucide-react";
