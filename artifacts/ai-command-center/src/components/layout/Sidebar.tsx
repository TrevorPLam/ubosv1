...
import { LayoutDashboard, MessageSquare, KanbanSquare, CalendarDays, FolderOpen, LineChart, FileText, Database, Blocks, Settings, Activity, PanelLeftClose, PanelLeftOpen } from "lucide-react";
